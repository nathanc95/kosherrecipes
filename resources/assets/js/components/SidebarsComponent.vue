    ...
    <div class="site-sidebar">
        ...
        <section class="widget astrif_widget_about">
            ...
            <div class="about-author-container">
                <div class="author-avatar">
                    <img src="img/astrif-about.jpg" alt="astrif fifth">
                </div>
                ...
                <div class="author-signature" style="background-image: url('('')}}/img/astrif-signature.png');"></div>
            ...
            <ul>
                <li>
                    <a href="/single" class="popular-entry-thumbnail">
                        <img src="img/astrif-popular-01.jpg" alt="10 Easy Breakfast that can try in home">
                    </a>
                ...
                <li>
                    <a href="/single" class="popular-entry-thumbnail">
                        <img src="img/astrif-popular-02.jpg" alt="My Daily healthy food">
                    </a>
                    <span class="popular-entry-title">
                ...
                <li>
                    <a href="/single" class="popular-entry-thumbnail">
                        <img src="img/astrif-popular-03.jpg" alt="Not drink a coke is good">
                    </a>
                    <span class="popular-entry-title">
                ...
                <li>
                    <a href="/single" class="popular-entry-thumbnail">
                        <img src="img/astrif-popular-04.jpg" alt="This pancake as sweet as you">
                    </a>
                    <span class="popular-entry-title">
                ...
                <li>
                    <a href="/single" class="popular-entry-thumbnail">
                        <img src="img/astrif-popular-05.jpg" alt="My daily drink in the morn">
                    </a>
                    <span class="popular-entry-title">
        ...
        <section class="widget widget_text">
            ...
            <div class="textwidget">
                <a href="/home"><img src="img/astrif-sidebar-banner.jpg" alt="buy astrif now"></a>
            </div>
